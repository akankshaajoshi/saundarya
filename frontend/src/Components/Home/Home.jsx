    ...
    return (
        <div>
            <nav className="navbar">
                <a className="logo" style={{fontStyle:'italic'}}>SOUNDARYA</a>
                ...
                <div className="home-box">
                    <div className="content-wrapper">
                        <div className="text-content">
                            <h1>About</h1>
                            <p>
                                Introducing "Soundarya" - your personal beauty advisor in your pocket!
                                Are you tired of guessing which makeup shades and clothing colors flatter
                                your unique skin tone? Look no further! Soundarya uses advanced AI
